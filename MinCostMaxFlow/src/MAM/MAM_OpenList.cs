...
namespace CPF_experiment
{
    ...
    public class MAM_OpenList
    {

        protected Dictionary<IBinaryHeapItem, IBinaryHeapItem> openNodes;
        protected Queue<IBinaryHeapItem> queue;
        protected BinaryHeap heap;

        protected MAM_ISolver user;
        ...
        public int Count
        {
            get { return this.openNodes.Count; }
        }
        ...
        public virtual void OutputAccumulatedStatistics
        (
            TextWriter output
        )
        {
